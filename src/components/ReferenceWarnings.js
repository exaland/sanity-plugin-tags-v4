...
export const ReferenceCreateWarning = () => (<Card padding={[3, 3, 4]} marginBottom={[3, 3, 4]} radius={2} shadow={1} tone="caution">
...
export const ReferencePredefinedWarning = () => (<Card padding={[3, 3, 4]} marginBottom={[3, 3, 4]} radius={2} shadow={1} tone="caution">
